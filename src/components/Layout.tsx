...
export const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Main Content */}
      <main className="flex-1 container mx-auto px-2 sm:px-4 py-3 sm:py-6 pb-24 md:pb-6">
        {children}
      </main>

      {/* Footer - Hidden on mobile to make room for bottom nav */}
      <footer className="hidden md:block text-center py-3 sm:py-4 text-gray-500 text-xs sm:text-sm border-t border-gray-800">
